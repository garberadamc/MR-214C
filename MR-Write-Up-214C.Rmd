...
Linearity was assessed using bivariate plots to assess the relationship between the two continuous predictors (School Spending and Parent Income) and the outcome variable (Test Scores). The left panel of Figure 2 displays the bivariate relationship between test scores and school spending with higher test scores being associated with higher school spending. This relationship is weak with high heterogeneity in test scores across the range of the school spending variable. The right panel of Figure 2, depicts a positive and moderately strong relationship between parent income and test scores. These plots provide sufficient evidence that the linearity assumption is satisfied for proceeding with the linear specification of these predictors. 
